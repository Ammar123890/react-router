...
function getHydrationData({
  ...
  let initialMatches = _chunk5XHXSQOYjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunk5XHXSQOYjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunk5XHXSQOYjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunk5XHXSQOYjs.useRouteError.call(void 0, );
