...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunk5XHXSQOYjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
...
function createRouterFromPayload({
  ...
  _chunkMQBE2BS3js.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  let patches = /* @__PURE__ */ new Map();
  _optionalChain([payload, 'access', _22 => _22.patches, 'optionalAccess', _23 => _23.forEach, 'call', _24 => _24((patch) => {
    _chunk5XHXSQOYjs.invariant.call(void 0, patch.parentId, "Invalid patch parentId");
  ...
  globalVar.__reactRouterDataRouter = _chunk5XHXSQOYjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunk5XHXSQOYjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkMQBE2BS3js.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunk5XHXSQOYjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunk5XHXSQOYjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunk5XHXSQOYjs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunk5XHXSQOYjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunk5XHXSQOYjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunk5XHXSQOYjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunk5XHXSQOYjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunk5XHXSQOYjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunk5XHXSQOYjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunk5XHXSQOYjs.setIsHydrated.call(void 0, );
  }, []);
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunk5XHXSQOYjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkMQBE2BS3js.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunk5XHXSQOYjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunk5XHXSQOYjs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunk5XHXSQOYjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunk5XHXSQOYjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
